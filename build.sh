...
export CMAKE_PREFIX_PATH=~/Qt/qt6-7-3_install
...
cd build
script -qec "cmake -Denable-tests=OFF -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_INSTALL_PREFIX=$(pwd)/../keyboard_install/ .. 2>&1" /dev/null | tee cmake_output.txt
